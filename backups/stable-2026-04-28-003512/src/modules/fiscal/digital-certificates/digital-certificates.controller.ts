...
export class DigitalCertificatesController {
  constructor(private readonly digitalCertificatesService: DigitalCertificatesService) {}
...
@Get()
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateDigitalCertificateDto: UpdateDigitalCertificateDto) {
    return this.digitalCertificatesService.update(id, updateDigitalCertificateDto);
  }
