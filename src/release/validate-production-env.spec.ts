...
describe('validate-production-env release gate', () => {
  ...
  it('oferece runner beta reprodutivel sem exigir Stripe live no ambiente local', () => {
  ...
  it('mantem o runner beta deterministico mesmo com variaveis oficiais herdadas do shell', () => {
    const result = spawnSync(process.execPath, [betaScriptPath], {
      cwd: process.cwd(),
      env: {
        ...baseEnv,
