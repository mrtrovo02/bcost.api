...
describe('backend CI workflow release contract', () => {
  ...
  it('keeps EC2 operational checks out of GitHub Actions because they require PM2 and local services', () => {
    expect(ciWorkflowSource).not.toContain('npm run ops:ec2-check');
  });
});
