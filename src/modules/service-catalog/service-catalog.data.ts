...
export const BCOST_SERVICE_CATALOG: MacroServiceDefinition[] = [
  {
    ...
    description: 'Criacao do CNPJ e definicao inicial da estrutura empresarial.',
    microServices: [
      {
        id: 'company-opening',
      ...
      { id: 'cnpj-registration', name: 'Registro de CNPJ', governmentFeesMayApply: true },
      ...
      { id: 'constitutive-acts', name: 'Elaboracao e registro dos atos constitutivos', governmentFeesMayApply: true },
      { id: 'municipal-state-registrations', name: 'Inscricoes municipais e estaduais', governmentFeesMayApply: true, municipalDependency: true },
      { id: 'government-fee-guidance', name: 'Orientacao sobre taxas governamentais', governmentFeesMayApply: true },
      { id: 'opening-onboarding', name: 'Reuniao coletiva de integracao' },
      { id: 'opening-tracking', name: 'Acompanhamento digital do processo de abertura' },
      { id: 'mei-to-me-migration', name: 'Desenquadramento/Migracao de MEI para ME', governmentFeesMayApply: true, addOnService: true, expertsHonorariumWaivable: true },
      { id: 'ltda-ei-to-mei', name: 'Transformacao de Limitada/EI em MEI', governmentFeesMayApply: true, addOnService: true, expertsHonorariumWaivable: true },
  ...
  },
  {
    ...
    description: 'Nucleo operacional dos planos mensais para manutencao da conformidade.',
    microServices: [
      { id: 'accounting-bookkeeping', name: 'Escrituracao contabil diaria/mensal' },
      { id: 'financial-classification', name: 'Classificacao e lancamento de movimentacoes financeiras' },
      ...
      { id: 'accounting-specialist-support', name: 'Atendimento por especialistas em contabilidade' },
    ],
  },
  {
    id: 3,
    ...
    microServices: [
      ...
      { id: 'fiscal-registration-update', name: 'Atualizacao cadastral perante Receita Federal e Prefeituras', addOnService: true, expertsHonorariumWaivable: true, governmentFeesMayApply: true, municipalDependency: true, activeCustomersOnly: true },
      { id: 'cpom-cepom', name: 'Cadastro CPOM/CEPOM', addOnService: true, municipalDependency: true, physicalProtocolMayApply: true, activeCustomersOnly: true },
      { id: 'no-revenue-declaration', name: 'Declaracao de Ausencia de Faturamento', addOnService: true, expertsHonorariumWaivable: true, activeCustomersOnly: true },
      { id: 'fiscal-certificates', name: 'Emissao de certidoes e documentos fiscais/cadastrais', addOnService: true, expertsHonorariumWaivable: true, governmentFeesMayApply: true, activeCustomersOnly: true },
    ],
  },
  {
    id: 4,
  ...
  },
  {
    ...
    microServices: [
      ...
      { id: 'receivable-advance', name: 'Recebimento antecipado sujeito a aprovacao financeira' },
      { id: 'automatic-reconciliation-dre', name: 'Conciliacao automatica entre extrato e DRE' },
    ],
  },
  {
    id: 6,
    ...
    microServices: [
      { id: 'free-pj-account', name: 'Abertura e manutencao de Conta Digital PJ gratuita' },
      { id: 'free-pix', name: 'Pix ilimitado e isento de tarifas operacionais' },
      { id: 'automatic-tax-monthly-fee-debit', name: 'Debito automatico de impostos e mensalidade' },
      { id: 'automatic-bank-statement-flow', name: 'Automacao de extratos sem OFX manual' },
  ...
  },
  {
    ...
    description: 'Transicao de responsabilidade tecnica para empresas existentes.',
    microServices: [
      { id: 'technical-responsibility-transfer', name: 'Troca de responsabilidade tecnica' },
      { id: 'prior-accountant-documents', name: 'Coleta e analise de documentos do contador anterior' },
      { id: 'initial-regularity-diagnosis', name: 'Diagnostico inicial de regularidade contabil e fiscal' },
      { id: 'history-import', name: 'Importacao de historico cadastral e financeiro' },
      { id: 'prior-period-pendency-guidance', name: 'Orientacao para pendencias anteriores', retroactiveSensitive: true, addOnService: true, activeCustomersOnly: true },
    ],
  },
  {
    id: 8,
    name: 'Alteracoes Empresariais e Cadastrais',
    description: 'Eventos contratuais e cadastrais geralmente tarifados como avulsos.',
    microServices: [
      { id: 'company-name-address-change', name: 'Alteracao de razao social, fantasia ou endereco', addOnService: true, expertsHonorariumWaivable: true, governmentFeesMayApply: true, municipalDependency: true, activeCustomersOnly: true },
      { id: 'partner-change', name: 'Inclusao, remocao ou substituicao de socios', addOnService: true, expertsHonorariumWaivable: true, governmentFeesMayApply: true, activeCustomersOnly: true },
      { id: 'capital-cnae-change', name: 'Capital social e CNAEs/atividades', addOnService: true, expertsHonorariumWaivable: true, governmentFeesMayApply: true, activeCustomersOnly: true },
      { id: 'legal-nature-change', name: 'Mudanca de natureza juridica', addOnService: true, expertsHonorariumWaivable: true, governmentFeesMayApply: true, activeCustomersOnly: true },
      { id: 'multi-agency-registration-update', name: 'Atualizacao simultanea Junta, Receita e Prefeituras', addOnService: true, expertsHonorariumWaivable: true, governmentFeesMayApply: true, municipalDependency: true, activeCustomersOnly: true },
      { id: 'business-license-update', name: 'Regularizacao e atualizacao de Alvara', addOnService: true, expertsHonorariumWaivable: true, governmentFeesMayApply: true, municipalDependency: true, physicalProtocolMayApply: true, activeCustomersOnly: true },
    ],
  },
  {
    id: 9,
    name: 'Licencas, Alvaras e Regularizacoes',
    description: 'Adequacao operacional perante orgaos municipais e reguladores.',
    microServices: [
      { id: 'business-license-issue-renewal', name: 'Emissao e renovacao de Alvara', addOnService: true, governmentFeesMayApply: true, municipalDependency: true, physicalProtocolMayApply: true, activeCustomersOnly: true },
      { id: 'sanitary-license', name: 'Licenciamento sanitario e dispensa municipal', addOnService: true, governmentFeesMayApply: true, municipalDependency: true, physicalProtocolMayApply: true, activeCustomersOnly: true },
      { id: 'municipal-provider-registration', name: 'Inscricao em cadastros municipais de prestadores', addOnService: true, municipalDependency: true, physicalProtocolMayApply: true, activeCustomersOnly: true },
      { id: 'municipal-registration-divergence', name: 'Saneamento de divergencias cadastrais', addOnService: true, expertsHonorariumWaivable: true, governmentFeesMayApply: true, municipalDependency: true, activeCustomersOnly: true },
    ],
  },
  {
    id: 10,
    ...
    microServices: [
      ...
      { id: 'certificate-validation-scheduling', name: 'Agendamento e validacao presencial ou por video' },
      { id: 'certificate-technical-support', name: 'Suporte tecnico de instalacao e uso' },
    ],
  },
  {
    id: 11,
    ...
    microServices: [
      { id: 'dissolution-document', name: 'Elaboracao do Distrato Social', addOnService: true, expertsHonorariumWaivable: true, activeCustomersOnly: true },
      { id: 'company-closure-agencies', name: 'Baixa na Junta, Receita e Prefeitura', addOnService: true, expertsHonorariumWaivable: true, governmentFeesMayApply: true, municipalDependency: true, activeCustomersOnly: true },
      { id: 'closure-tenure-treatment', name: 'Tratamento por tempo de casa', addOnService: true, activeCustomersOnly: true },
      { id: 'recurring-billing-cancellation', name: 'Cancelamento da recorrencia apos marco contratual' },
    ],
  },
  {
    id: 12,
    ...
    microServices: [
      { id: 'revenue-declaration', name: 'Declaracao de Faturamento', addOnService: true, expertsHonorariumWaivable: true, activeCustomersOnly: true },
      { id: 'no-revenue-document-declaration', name: 'Declaracao de Ausencia de Faturamento', addOnService: true, expertsHonorariumWaivable: true, activeCustomersOnly: true },
      { id: 'commercial-board-certificates', name: 'Certidoes Simplificadas e Inteiro Teor', addOnService: true, expertsHonorariumWaivable: true, governmentFeesMayApply: true, activeCustomersOnly: true },
      { id: 'registry-pendency-opinion', name: 'Parecer sobre pendencias cadastrais', addOnService: true, expertsHonorariumWaivable: true, retroactiveSensitive: true, activeCustomersOnly: true },
    ],
  },
  {
    id: 13,
    ...
    microServices: [
      { id: 'brand-viability-guidance', name: 'Orientacao inicial sobre registro no INPI', addOnService: true },
      { id: 'brand-process-guidance', name: 'Apoio explicativo sobre processo administrativo' },
      { id: 'brand-specialized-partner', name: 'Encaminhamento para parceiro especializado', addOnService: true },
    ],
  },
  {
    id: 14,
    ...
    microServices: [
      { id: 'ticket-email-chat-support', name: 'Atendimento via Ticket, E-mail e Chat' },
      { id: 'whatsapp-phone-support', name: 'WhatsApp e Telefone em planos avancados/Experts' },
      { id: 'extended-support-hours', name: 'Atendimento estendido ate 22h' },
      { id: 'segment-specialists', name: 'Especialistas setorizados' },
      { id: 'dedicated-advisor', name: 'Assessor dedicado exclusivo no Experts' },
      { id: 'experts-addon-honorarium-waiver', name: 'Isencao de honorarios em servicos avulsos no Experts' },
    ],
  },
  {
    id: 15,
    ...
    microServices: [
      ...
      { id: 'health-plan-brokerage', name: 'Intermediacao de Planos de Saude Empresariais' },
    ],
  },
  {
    id: 16,
    ...
    microServices: [
      ...
      { id: 'regulated-professions-segment', name: 'Advocacia, Engenharia e Arquitetura' },
      { id: 'commerce-ecommerce-segment', name: 'Comercio e E-commerce', municipalDependency: true },
      { id: 'individual-professionals-segment', name: 'Freelancers, PJs e Autonomos' },
    ],
  },
];
